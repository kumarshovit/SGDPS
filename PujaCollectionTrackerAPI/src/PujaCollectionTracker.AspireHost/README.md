...
1. Set `PujaCollectionTracker.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../PujaCollectionTracker.Infrastructure/PujaCollectionTracker.Infrastructure.csproj -s PujaCollectionTracker.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../PujaCollectionTracker.Infrastructure/PujaCollectionTracker.Infrastructure.csproj -s PujaCollectionTracker.Web.csproj
```
