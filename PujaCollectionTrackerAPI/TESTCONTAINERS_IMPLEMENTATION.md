...
**Updated `tests\PujaCollectionTracker.FunctionalTests\PujaCollectionTracker.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\PujaCollectionTracker.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\PujaCollectionTracker.FunctionalTests\PujaCollectionTracker.FunctionalTests.csproj
```
