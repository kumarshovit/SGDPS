...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed top-0 left-0 z-40 h-screen border-r border-cream-border/90 dark:border-charcoal-700 bg-[#221612] dark:bg-[#120B08] text-cream-100 transition-all duration-300 ease-in-out flex flex-col shadow-xl',
          // Mobile state
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-h-0">
          <div className="flex h-16 items-center justify-between px-4 border-b border-cream-border/20 dark:border-charcoal-700/80 flex-shrink-0">
            <div
